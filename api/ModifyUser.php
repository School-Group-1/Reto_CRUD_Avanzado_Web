...
try{
    if ($modify) {
        ...
        echo json_encode([ "success"   => true, "code" => 200, "message" => "User modified correctly.", "data" => "works" ]);
    } else {
        
            header("Content-Type: application/json; charset=UTF-8"); 
            http_response_code(400);
            echo json_encode([ "success"   => false, "code" => 400, "message" => "Error Updating data", "data" => "" ]);
    }
}catch(Exception $e){
     header("Content-Type: application/json; charset=UTF-8"); 
        http_response_code(500);
        echo json_encode([ "success"   => false, "code" => 500, "message" => "Server error", "data" => "" ]);
